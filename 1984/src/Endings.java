public class Endings {
	// Here are several ending texts
    public static void gameOverOne() {
        System.out.println("Without a look at the sides, you cross the Street. Screeching tires," 
					+ "\na loud noise and a short pain on the right arm and head." 
					+ "\n Then NOTHING AS DARKNESS. Game over, a car with a poster of Big Brother on the side crashes into you.");
        System.exit(0);
    }
    public static void gameOverTwo() {
        System.out.println("A loud BAAAAAM at the door. then 5 people, all from the Thought Police, " 
					+ "\nrun into your flat and take position around you." 
					+ "\nA black bag over your face and a hard blow to the head." 
					+ "\nThen DARKNESS. (Game Over. The Thought Police come to get you)");
        System.exit(0);
    }
    public static void gameOverThree() {
        System.out.println("You run after him, but he is very fast." 
					+ "\nTwo meters behind him you both reach the street." 
					+ "\nA group of men stand next to the door. They hear the words the boy screams," 
					+ "\ncome over and hold you. Unfortunately, they discover themselves as members of the Thought Police." 
					+ "\nThey ask the boy for the reason of his screaming." 
					+ "\nHe tells them what he had seen on your table." 
    ...
    public static void gameOverFive() {
        System.out.println("One of them come closer and put a black bag over your face and hit you hard on the head." 
					+ "\nYou go black before the eyes.");
        System.exit(0);
    }
    public static void gameOverSix() {
        System.out.println("You pass the corner, then one more." 
					+ "\nExactly when you run over the street a noisy sound about you, a light and a pain never felt." 
					+ "\nYou lie on the street. Around you fearful faces." 
					+ "\nA child asks his mother why the man doesnÂ´t have any legs." 
					+ "\nYou feel a sticky wet liquid under your body. Then your view turns black. ");
        System.exit(0);
    }
    public static void gameOverSeven() {
        System.out.println("You walk another street when a loud noisy sound comes from up to you." 
					+ "\nThen a loud explosion, a brightly light, a pain and darkness." 
					+ "\nAnother bomb dropped directly in front of you. ");
        System.exit(0);
    }
    public static void gameOverEight() {
        System.out.println("You try to leave London by train in a risky action during the night." 
					+ "\nThe police are standing at the railroad track, your ID is checked." 
					+ "\nYou are caught, the thought police arrest you.");
        System.exit(0);
    }
    public static void gameOverNine() {
        System.out.println("You sitting at home with beads of sweat on his forehead, they could show up here at any time." 
					+ "\nYou try to burn your diary... there is a knock at the door... " 
					+ "\nknock knock thoughts police, open the door, you are under arrest.");
        System.exit(0);
    }
        public static void gameOverTen() {
            System.out.println("As you run around a corner, you get hit on the head......" 
					+ "\nYou wake up but you can't see, they put a bag over your head." 
					+ "\nYou ask if someone can hear you." 
					+ "\nBANG The Tought police didn't believe your excuse and chased you." 
					+ "\nThey intercepted you, knocked you down and executed you.");
            System.exit(0);        
    }
        public static void gameOverEleven() {
            System.out.println("you hide behind a bush. Suddenly you feel a thud on your head." 
					+ "\nYou wake up but you can't see, they put a bag over your head." 
					+ "\nYou ask if someone can hear you." 
					+ "\nBANG The Tought police didn't believe your excuse and chased you." 
					+ "\nThey intercepted you, knocked you down and executed you.");
