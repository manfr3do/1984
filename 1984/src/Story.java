...
public class Story {
    ...
    // Declare decisions for if/else statements
    private boolean decisionA;
    private boolean decisionB;
    private boolean decisionC;
    
    // Declare ending variable to use for several endings
    private int ending;
    
    // Calculate the points during the game
    public int traitor() {
            traitorPoints = traitorPoints - partyPoints;
    ...
    public void start() {
        ...
        do {
            ...
            while(story == 1 && traitorPoints <= 10) {
                ...
                Game.fastPrint("The story takes place in Oceania," 
                    + "\none of the three powerblocks in the world," 
                    + "\nbut precicely in Airstrip 1, which is England at the time.\n\n");
            ...
            while(story == 8 && traitorPoints <= 10) {
                ...
                if(decisionA) {
                    System.out.println("Mrs Parson stands in front of you and asks for your help."
                        + "\nYou agree, happy that she had not notice the diary. You follow her in her flat."
                        + "\nSomething must be repaired, the kitchen sink or something else. Of course." 
                        + "\nTo live in these old houses from the 1930 means to fix something very often." 
                        + "\nBecause of your own experience to repair things on your own flat, you got skills and finish the work very fast."
                        + "\nAfter a short talk to Mrs Parsons terrible children, you leave the apartment and go back in your own.");
                }  else {
                ...
                System.out.print("\n\n");    
                System.out.println("The next day. You are at work in the Ministry of Truth." 
                        + "\nYou must correct a part of an article in which BIG BROTHER said that Eurasia would leave South India and attack North Africa." 
                        + "\nBut it happened the other way around");
                System.out.print("\n\n"); 
                System.out.println("(a): A warm feeling comes around you. You enjoy writing on tasks like this." 
            ...
            while(story == 9 && traitorPoints <= 10) {
                ...
                System.out.println("Then it rings for lunch. You go to the cafeteria.");       
            ...
            while(story == 11 && traitorPoints <= 10) {
                ...
                if(decisionA) {
                    ...
                    System.out.println("You go to the canteen with the feeling that you have just managed to get your head out of the noose.");
                }
                
                System.out.print("\n\n");    
                System.out.println("At the canteen you meet with Syme. He talks about the eleventh edition of Newspeak." 
                        + "\nHe asks you if you have an idea how he could rewrite or exchange some words.");
                System.out.print("\n\n"); 
                System.out.println("(a): In thoughts and exhausted from your work you say that all the time a new edition is truly bullshit and not necessary." 
                        + "\nIt is always very terrible to remember which words are part of the new edition.");
                System.out.print("\n"); 
            ...
            while(story == 12 && traitorPoints <= 10) {
                ...
                System.out.println("(b): Two metres behind him you jump on his back and push him on the wall." 
                        + "\nYou whistle in his ear that you can proof he is guilty in thoughtcrime," 
                        + "\nand you would if he ever tells anyone what you have said." 
                        + "\nYou start to scream that you give a damn on the 11th edition of Newspeak," 
            ...
            while(story == 13 && traitorPoints <= 10) {
                ...
                System.out.print("\n\n");    
                System.out.println("Just a few seconds later you find yourself surrounded by several dark dressed men." 
                        + "\nYou have no illusions about what they want and who they are.");
            ...
            while(story == 14 && traitorPoints <= 10) {
                ...
                if(decisionB) {
                    System.out.println("Until Comrade Parson comes to your table you make up new words." 
                        + "\nWhen he arrives, you change the subject of the conversation.");
                } else {
                    System.out.println("It seems that you just hurt Syme, when you told him his work is useless and bullshit." 
                        + "\nBut now he calms. He pats you on the shoulders," 
                        + "\nsmiles and says that he was shocked about your words but never thought that it was your real opinion. Then he goes his way.");
                }
                
                System.out.print("\n\n");    
                System.out.println("During a walk you hear a loud explosion some blogs away. A bomb dropped." 
                        + "\nYou are afraid. Was it the last or will others follow? Should you run or should you take cover?");
                System.out.print("\n\n"); 
            ...
            while(story == 15 && traitorPoints <= 10) {
                ...
                System.out.print("\n\n");    
                System.out.println("You pass another corner and stand in front of a bar for proles." 
                        + "\nYou step in. Maybe you can find out something about the time before Big Brother here.");
                
                System.out.print("\n\n"); 
                System.out.println("(a): A pack of proles are talking about the lottery at the counter." 
            ...
            while(story == 17 && traitorPoints <= 10) {
                ...
                if(decisionA) {
                	...
                	System.out.println("irritated and suspicious the men look at you and your overall." 
                        + "\nThen they tell you that they don´t know about a time before and you shall go away.");
                }else {
                    System.out.println("Outside you go along a street that looks very familiar to you.");  
                }
                                
                System.out.print("\n\n");    
                System.out.println("Next to you is the little shop where you once bought the diary book." 
                        + "\nIndecisively you stand in front of the door." 
                        + "\nThen you decide to go in. Inside the fulfilled shop you meet the owner Mr Charrington.");
                
                System.out.print("\n\n"); 
                System.out.println("(a): You find a little paperweight from glass and a coral inside." 
                        + "\nIt´s a beautiful thing. You buy it for more then the old wants for it.");
                System.out.print("\n"); 
                System.out.println("(b): You look around but here is nothing you are interested in." 
            ...
            while(story == 18 && traitorPoints <= 10) {
                ...
                System.out.println("The conversation to Mr Charrington is very interesting." 
                        ...
                        + "\nThe he shows you a room upstairs which looks comfortable and with no telescreen in it." 
                        + "\nHappy you leave the shop. You saw a lot of beautiful things.");                           
                System.out.print("\n\n");    
                ...
                command = sc.nextLine();
                Game.clrscr();
                System.out.println("Maybe she is an agent of the Thought Police," 
                        + "\nor simply an amateur spy actuated by officiousness, hardly mattered." 
                        + "\nIt was enough that she was watching him. Probably she had seen him go into the pub as well." 
                        + "\nThen the spasm passed, leaving a dull ache behind." 
                        + "\nFor several seconds wondering vaguely what to do, then turned round and began to retrace his steps.\n");
                System.out.print("> ");
                command = sc.nextLine();
                Game.clrscr();
                System.out.println("As he turned it occurred to him that the girl had only passed him three minutes ago and that by running he could probably catch up with her." 
                        + "\nHe could keep on her track till they were in some quiet place," 
                        + "\nand then smash her skull in with a cobblestone. The piece of glass in his pocket would be heavy enough for the job.\n"
                		+ "\n\nFor a few seconds you are too paralysed to move." 
                        + "\nMaybe you should smash her skull with the piece of glass in a blind alley, or should he walk further? ");
            ...
            while(story == 20 && traitorPoints <= 10) {
                ...
                System.out.println("You´re home again, you went into the kitchen and swallow nearly a teacupful of Victory Gin.\n"
                		+ "You went to the table and took the diary out of the drawer," 
                        + "\nbut you did not open it," 
                        + "\nyou only stare at the cover of the book and trying without success to shut the voice out if his consciousness.\n");
                System.out.println("\nPress Enter to continue");
                System.out.print("> ");
                command = sc.nextLine();
                Game.clrscr();
            ...
            while(story == 21 && traitorPoints <= 10) {
                ...
                command = sc.nextLine();
                Game.clrscr();
                System.out.println("A few days later the girl is sitting alone at a table in the canteen. You try to get over." 
                        + "\nPerhaps three meters away, a voice behind you called, 'Smith'. It was Wilsher.");
            ...
            if(decisionB) {    
            	...
            	System.out.println("The tought police let you go, you go to the meeting point and wait a bit," 
                        + "\nthe girl shows up and you disappear together in the forest.");
            }
            ...
            if(decisionA) {             	 
                ...
                System.out.print("\n\n"); 
                System.out.print("O'Brien was part of the inner party," 
                        + "\nhe approaches you about your work and asks if you are interested in the new dictionary edition of newspeak and whether you want to pick them up at his house."); 
                System.out.print("\n\n"); 
